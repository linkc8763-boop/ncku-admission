...
const RESULT_DATA = {
  ...
  name: '許詠鈞',
  identity: '一般生',
  rankMsg: '恭喜！您正取第28名。請於4/1前攜帶畢業證書前往電機工程學系辦公室報到，應屆生需簽署切結書',
  avgScore: '83.3',
  minAccepted: '--',
  minWait: '--',
  subjects: [
    { name: '工程數學', score: '81.5', percent: '40.00%' },
    { name: '電子學', score: '85.0', percent: '30.00%' },
    { name: '電磁學', score: '84.0', percent: '30.00%' }
  ]
};
